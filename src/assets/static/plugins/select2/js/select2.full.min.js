  ...
  var e = function () {
    ...
    return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, r = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function (e, t) {
      ...
      return f.Extend(i, f.Observable), i.prototype.render = function () {
        ...
        this.$results.attr("id", n), t.on("results:all", function (e) {
          ...
          if (!(n >= t.length)) {
            ...
            var r = l.$results.offset().top + l.$results.outerHeight(!1), o = i.offset().top + i.outerHeight(!1),
        ...
        if (0 !== e.length) {
          var t = this.$results.find("[aria-selected]").index(e), n = this.$results.offset().top, i = e.offset().top,
      ...
      return e.prototype.bind = function (e, t, n) {
        ...
        var s = this.$dropdown.outerHeight(!1), a = e.scrollTop(), l = e.scrollTop() + e.height(), c = a < r.top - s,
          u = l > r.bottom + s, d = {left: r.left, top: o.bottom}, p = this.$dropdownParent;
      ...
      return n.prototype.apply = function (e) {
        ...
        var n = e.language, i = this.defaults.language, r = t.prop("lang"), o = t.closest("[lang]").prop("lang"),
